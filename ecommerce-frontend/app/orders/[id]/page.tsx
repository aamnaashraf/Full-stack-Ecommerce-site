    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F9FF] via-white to-[#F0F7FF]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 sm:py-12">
        ...
        <div className="mb-8 animate-fadeInUp">
          <div className="bg-gradient-to-r from-[#0D6EFD] via-[#2B7FFF] to-[#4A90FF] rounded-[20px] p-6 sm:p-8 shadow-xl relative overflow-hidden">
            {/* Decorative circles */}
            ...
            <div className="relative flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              ...
              <span className={`px-5 py-2.5 rounded-full text-sm font-bold ${getStatusColor(order.status)} self-start sm:self-center shadow-lg hover:scale-105 transition-transform duration-300`}>
        ...
        <div className="grid lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            {/* Order Items */}
            <div className="bg-white rounded-[20px] border border-[#DEE2E7] p-6 shadow-lg hover:shadow-2xl transition-all duration-300 animate-fadeInUp">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-[#E7F0FF]">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#0D6EFD] to-[#4A90FF] flex items-center justify-center shadow-md">
                ...
                <h2 className="text-xl font-bold text-[#1C1C1C]">Order Items</h2>
              </div>
              <div className="space-y-4">
                {order.order_items.map((item, index) => (
                  <div
                    key={item.id}
                    className="group flex gap-4 p-5 border-2 border-[#DEE2E7] rounded-[16px] hover:border-[#0D6EFD] hover:shadow-lg hover:scale-[1.02] transition-all duration-300"
                    style={{ animationDelay: `${index * 100}ms` }}
                  >
                    <div className="w-20 h-20 bg-gradient-to-br from-[#E7F0FF] to-[#F7FAFC] rounded-[12px] flex items-center justify-center flex-shrink-0 group-hover:scale-110 transition-transform duration-300 shadow-md">
                    ...
                    <div className="flex-1">
                      <h3 className="font-bold text-[#1C1C1C] mb-2 group-hover:text-[#0D6EFD] transition-colors duration-300">
                        Product ID: {item.product_id}
                      </h3>
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-3 py-1 bg-[#E7F0FF] text-[#0D6EFD] text-xs font-semibold rounded-full">
                          Qty: {item.quantity}
                        </span>
                    ...
                    <div className="text-right flex flex-col justify-center">
                      ...
                      <p className="text-xl font-bold text-[#0D6EFD] group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="bg-white rounded-[20px] border border-[#DEE2E7] p-6 shadow-lg hover:shadow-2xl transition-all duration-300 animate-fadeInUp">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-[#E7F0FF]">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00B517] to-[#00D61F] flex items-center justify-center shadow-md">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
              ...
              <div className="bg-gradient-to-br from-[#F5F9FF] to-[#EBF4FF] rounded-[16px] p-5 space-y-3 border border-[#D6E9FF]">
                <div className="flex items-start gap-3">
                  ...
                  <p className="font-bold text-[#1C1C1C] text-lg">{order.full_name}</p>
                </div>
                <div className="flex items-start gap-3">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" className="mt-1 flex-shrink-0">
                ...
                <div className="border-t border-[#D6E9FF] pt-3 space-y-2">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-[#505050]">{order.phone}</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                    ...
                    <span className="text-[#505050]">{order.email}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-[20px] border border-[#DEE2E7] p-6 shadow-lg hover:shadow-2xl transition-all duration-300 animate-fadeInUp">
              <div className="flex items-center gap-3 mb-6 pb-4 border-b-2 border-[#E7F0FF]">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#FF9017] to-[#FFB84D] flex items-center justify-center shadow-md">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <h2 className="text-xl font-bold text-[#1C1C1C]">Order Summary</h2>
              </div>
              <div className="space-y-4">
                <div className="flex justify-between items-center p-3 bg-gradient-to-r from-[#F5F9FF] to-[#EBF4FF] rounded-[10px] border border-[#D6E9FF]">
                  <span className="text-[#505050] font-medium">Subtotal</span>
                  <span className="font-bold text-[#1C1C1C]">${order.total_amount.toFixed(2)}</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-gradient-to-r from-[#E7F5E9] to-[#D4F0DC] rounded-[10px] border border-[#B8E6C5]">
                  <span className="text-[#505050] font-medium">Shipping</span>
                  <span className="font-bold text-[#00B517] flex items-center gap-1">
                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none">
                ...
                <div className="bg-gradient-to-r from-[#0D6EFD] to-[#4A90FF] rounded-[12px] p-4 flex justify-between items-center shadow-lg">
                  <span className="text-lg font-bold text-white">Total</span>
                  <span className="text-2xl font-bold text-white">${order.total_amount.toFixed(2)}</span>
                </div>
              </div>
            </div>
            ...
            {/* Payment Method */}
            <div className="bg-white rounded-[20px] border border-[#DEE2E7] p-6 shadow-lg hover:shadow-2xl transition-all duration-300 animate-fadeInUp">
              <div className="flex items-center gap-3 mb-4 pb-4 border-b-2 border-[#E7F0FF]">
                <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#0D6EFD] to-[#4A90FF] flex items-center justify-center shadow-md">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
                ...
                <h2 className="text-xl font-bold text-[#1C1C1C]">Payment</h2>
              </div>
              <div className="bg-gradient-to-br from-[#F5F9FF] to-[#EBF4FF] rounded-[12px] p-4 flex items-center gap-4 hover:scale-105 transition-transform duration-300 border border-[#D6E9FF]">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-[#0D6EFD] to-[#4A90FF] flex items-center justify-center shadow-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-[#8B96A5]">Payment method</p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 animate-fadeInUp">
              <Link
                href="/orders"
                className="block w-full px-6 py-4 bg-gradient-to-r from-[#0D6EFD] to-[#4A90FF] text-white text-center rounded-[12px] font-bold hover:shadow-2xl hover:scale-105 transition-all duration-300 shadow-lg"
              >
              ...
              <Link
                href="/contact"
                className="block w-full px-6 py-4 bg-white border-2 border-[#0D6EFD] text-[#0D6EFD] text-center rounded-[12px] font-bold hover:bg-gradient-to-r hover:from-[#0D6EFD] hover:to-[#4A90FF] hover:text-white hover:border-transparent hover:shadow-2xl hover:scale-105 transition-all duration-300 shadow-md"
              >
                <span className="flex items-center justify-center gap-2">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
